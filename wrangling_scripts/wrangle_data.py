...
# fourth chart shows rural population vs arable land
    ...
    my_data = pd.read_csv('data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv', skiprows=4)
    new_df = my_data[my_data['Country Name'].isin(['United States',
                                                   'China',
                                                   'Japan',
                                                   'Germany',
                                                   'United Kingdom',
    ...
    graph_five = []
    countrylist = new_df['Country Name'].unique().tolist()
    print(countrylist)
    ...
    layout_five = dict(title='Country / Rural Population 2015',
                       xaxis=dict(title='Country'),
                       yaxis=dict(title='Rural Population in 2015'),
                       )
    figures = []
